...
from .views import CarViewSet, ClientViewSet, RepairViewSet, PartViewSet, BalanceViewSet, MechanicViewSet, SparePartViewSet, RepairSparePartViewSet, ServiceViewSet, RepairServiceViewSet
